...
require (
	...
	github.com/bloxapp/dkg-spec v0.0.0-00010101000000-000000000000
...
replace github.com/bloxapp/dkg-spec => github.com/MatusKysel/dkg-spec v0.0.0-20240415083516-9cb655322c70
