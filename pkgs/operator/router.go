...
func RegisterRoutes(s *Server) {
	...
	addRoute(s.Router, "POST", "/store_resign", s.unsignedResignHandler, rateLimit(s.Logger, routeLimit))
	addRoute(s.Router, "POST", "/store_reshare", s.unsignedReshareHandler, rateLimit(s.Logger, routeLimit))
}
