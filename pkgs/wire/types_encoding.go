...
// Hash: 7fb1de83527f71942fc243ff17025aa6954ac25dae220f509153e27846454789
// Version: 0.1.3
package wire
...
func (p *Pong) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'EthClientConnected'
	dst = ssz.MarshalBool(dst, p.EthClientConnected)
...
func (p *Pong) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Multisig'
	p.Multisig = ssz.UnmarshalBool(buf[12:13])

	// Field (3) 'EthClientConnected'
	p.EthClientConnected = ssz.UnmarshalBool(buf[13:14])
...
func (p *Pong) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (2) 'Multisig'
	hh.PutBool(p.Multisig)

	// Field (3) 'EthClientConnected'
	hh.PutBool(p.EthClientConnected)
...
func (s *SignedResign) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'Signature'
	if size := len(s.Signature); size > 2048 {
		err = ssz.ErrBytesLengthFn("SignedResign.Signature", size, 2048)
		return
	}
	dst = append(dst, s.Signature...)
...
func (s *SignedReshare) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'Signature'
	if size := len(s.Signature); size > 2048 {
		err = ssz.ErrBytesLengthFn("SignedReshare.Signature", size, 2048)
		return
	}
	dst = append(dst, s.Signature...)
