...
// Hash: 83a7b99cd7748cd7813a7b16dc4eea51e0a9f836c98220e74b6b11ab623f9d64
// Version: 0.1.3
package wire
...
// MarshalSSZ ssz marshals the ValidateKeyshares object
func (v *ValidateKeyshares) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(v)
}

// MarshalSSZTo ssz marshals the ValidateKeyshares object to a target array
func (v *ValidateKeyshares) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(24)

	// Offset (0) 'Operators'
	dst = ssz.WriteOffset(dst, offset)
	for ii := 0; ii < len(v.Operators); ii++ {
		offset += 4
		offset += v.Operators[ii].SizeSSZ()
	}

	// Field (1) 'T'
	dst = ssz.MarshalUint64(dst, v.T)

	// Offset (2) 'Keyshares'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(v.Keyshares)

	// Offset (3) 'CeremonySigs'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(v.CeremonySigs)

	// Offset (4) 'InitiatorPublicKey'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(v.InitiatorPublicKey)

	// Field (0) 'Operators'
	if size := len(v.Operators); size > 13 {
		err = ssz.ErrListTooBigFn("ValidateKeyshares.Operators", size, 13)
		return
	}
	{
		offset = 4 * len(v.Operators)
		for ii := 0; ii < len(v.Operators); ii++ {
			dst = ssz.WriteOffset(dst, offset)
			offset += v.Operators[ii].SizeSSZ()
		}
	...
	for ii := 0; ii < len(v.Operators); ii++ {
		if dst, err = v.Operators[ii].MarshalSSZTo(dst); err != nil {
			return
		}
	}

	// Field (2) 'Keyshares'
	if size := len(v.Keyshares); size > 32768 {
		err = ssz.ErrBytesLengthFn("ValidateKeyshares.Keyshares", size, 32768)
		return
	}
	dst = append(dst, v.Keyshares...)

	// Field (3) 'CeremonySigs'
	if size := len(v.CeremonySigs); size > 16384 {
		err = ssz.ErrBytesLengthFn("ValidateKeyshares.CeremonySigs", size, 16384)
		return
	}
	dst = append(dst, v.CeremonySigs...)

	// Field (4) 'InitiatorPublicKey'
	if size := len(v.InitiatorPublicKey); size > 612 {
		err = ssz.ErrBytesLengthFn("ValidateKeyshares.InitiatorPublicKey", size, 612)
		return
	}
	dst = append(dst, v.InitiatorPublicKey...)

	return
}

// UnmarshalSSZ ssz unmarshals the ValidateKeyshares object
func (v *ValidateKeyshares) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 24 {
		return ssz.ErrSize
	...
	// Field (1) 'T'
	v.T = ssz.UnmarshallUint64(buf[4:12])
	...
	// Field (0) 'Operators'
	{
		...
		v.Operators = make([]*Operator, num)
		err = ssz.UnmarshalDynamic(buf, num, func(indx int, buf []byte) (err error) {
			if v.Operators[indx] == nil {
				v.Operators[indx] = new(Operator)
			}
			if err = v.Operators[indx].UnmarshalSSZ(buf); err != nil {
				return err
			}
			return nil
		})
	...
	// Field (2) 'Keyshares'
	{
		...
		if cap(v.Keyshares) == 0 {
			v.Keyshares = make([]byte, 0, len(buf))
		}
		v.Keyshares = append(v.Keyshares, buf...)
	}
	...
	// Field (3) 'CeremonySigs'
	{
		...
		if cap(v.CeremonySigs) == 0 {
			v.CeremonySigs = make([]byte, 0, len(buf))
		}
		v.CeremonySigs = append(v.CeremonySigs, buf...)
	}
	...
	// Field (4) 'InitiatorPublicKey'
	{
		...
		if cap(v.InitiatorPublicKey) == 0 {
			v.InitiatorPublicKey = make([]byte, 0, len(buf))
		}
		v.InitiatorPublicKey = append(v.InitiatorPublicKey, buf...)
	}
	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the ValidateKeyshares object
func (v *ValidateKeyshares) SizeSSZ() (size int) {
	size = 24

	// Field (0) 'Operators'
	for ii := 0; ii < len(v.Operators); ii++ {
		size += 4
		size += v.Operators[ii].SizeSSZ()
	}

	// Field (2) 'Keyshares'
	size += len(v.Keyshares)

	// Field (3) 'CeremonySigs'
	size += len(v.CeremonySigs)

	// Field (4) 'InitiatorPublicKey'
	size += len(v.InitiatorPublicKey)

	return
}

// HashTreeRoot ssz hashes the ValidateKeyshares object
func (v *ValidateKeyshares) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(v)
}

// HashTreeRootWith ssz hashes the ValidateKeyshares object with a hasher
func (v *ValidateKeyshares) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()

	// Field (0) 'Operators'
	{
		subIndx := hh.Index()
		num := uint64(len(v.Operators))
		if num > 13 {
			err = ssz.ErrIncorrectListSize
			return
		}
		for _, elem := range v.Operators {
			if err = elem.HashTreeRootWith(hh); err != nil {
				return
			}
		}
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(v.Keyshares))
		if byteLen > 32768 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.Append(v.Keyshares)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (32768+31)/32)
	}
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(v.CeremonySigs))
		if byteLen > 16384 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.Append(v.CeremonySigs)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (16384+31)/32)
	}
	...
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(v.InitiatorPublicKey))
		if byteLen > 612 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.Append(v.InitiatorPublicKey)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (612+31)/32)
	}
...
// GetTree ssz hashes the ValidateKeyshares object
func (v *ValidateKeyshares) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(v)
}

// MarshalSSZ ssz marshals the ValidatationResult object
func (v *ValidatationResult) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(v)
}

// MarshalSSZTo ssz marshals the ValidatationResult object to a target array
func (v *ValidatationResult) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(4)

	// Offset (0) 'Signature'
	dst = ssz.WriteOffset(dst, offset)
	offset += len(v.Signature)

	// Field (0) 'Signature'
	if size := len(v.Signature); size > 4096 {
		err = ssz.ErrBytesLengthFn("ValidatationResult.Signature", size, 4096)
		return
	}
...
// UnmarshalSSZ ssz unmarshals the ValidatationResult object
func (v *ValidatationResult) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 4 {
		return ssz.ErrSize
	...
	// Field (0) 'Signature'
	{
		...
		if cap(v.Signature) == 0 {
			v.Signature = make([]byte, 0, len(buf))
		}
		v.Signature = append(v.Signature, buf...)
	}
	return err
}

// SizeSSZ returns the ssz encoded size in bytes for the ValidatationResult object
func (v *ValidatationResult) SizeSSZ() (size int) {
	size = 4
...
// HashTreeRoot ssz hashes the ValidatationResult object
func (v *ValidatationResult) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(v)
}

// HashTreeRootWith ssz hashes the ValidatationResult object with a hasher
func (v *ValidatationResult) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	indx := hh.Index()

	// Field (0) 'Signature'
	{
		elemIndx := hh.Index()
		byteLen := uint64(len(v.Signature))
		if byteLen > 4096 {
			err = ssz.ErrIncorrectListSize
			return
		}
		hh.Append(v.Signature)
		hh.MerkleizeWithMixin(elemIndx, byteLen, (4096+31)/32)
	}
...
// GetTree ssz hashes the ValidatationResult object
func (v *ValidatationResult) GetTree() (*ssz.Node, error) {
	return ssz.ProofTree(v)
}
