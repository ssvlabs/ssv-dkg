...
// Hash: 575fb7bf6d68ab418e95eb52eb39f160563652efa2bbb70b551c21c9580479b8
// Version: 0.1.3
package wire
...
func (t *Transport) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'Version'
	if size := len(t.Version); size > 2048 {
		err = ssz.ErrBytesLengthFn("Transport.Version", size, 2048)
		return
	}
...
func (r *ResultData) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (1) 'InitiatorPublicKey'
	if size := len(r.InitiatorPublicKey); size > 2048 {
		err = ssz.ErrBytesLengthFn("ResultData.InitiatorPublicKey", size, 2048)
		return
	}
	dst = append(dst, r.InitiatorPublicKey...)
