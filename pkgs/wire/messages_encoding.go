...
// Hash: 5b3728c73b9015197f6582de2e667998c10e4066235e7a36c7c31e31ec678d67
// Version: 0.1.3
package wire
...
func (r *Reshare) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (6) 'Coefs'
	if size := len(r.Coefs); size > 4096 {
		err = ssz.ErrBytesLengthFn("Reshare.Coefs", size, 4096)
		return
	}
	dst = append(dst, r.Coefs...)
...
func (r *Reshare) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (6) 'Coefs'
	if o6 = ssz.ReadOffset(buf[52:56]); o6 > size || o4 > o6 {
		return ssz.ErrOffset
	}
	...
	// Field (6) 'Coefs'
	{
		...
		if cap(r.Coefs) == 0 {
			r.Coefs = make([]byte, 0, len(buf))
		}
		r.Coefs = append(r.Coefs, buf...)
	}
	return err
}
