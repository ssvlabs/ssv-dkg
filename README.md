...
To build from source you'll need to have Go version 1.25.13 installed on your system

##### Build

A prerequisite for this is to have `go` version 1.25.13 installed on the system, and an optional requirement is to have the `make` tool installed as well (alternatively you could run the corresponding command defined in the `Makefile`).
